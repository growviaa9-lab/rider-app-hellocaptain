...
const UploadDrivingLicenseScreen: React.FC = () => {
  ...
  const handleContinue = () => {
    if (dlNumber && frontImage && backImage) {
      // Navigate to next screen
      navigation.navigate('UploadIDCard' as never);
    } else {
      ...
      <KeyboardAvoidingView behavior="padding" className="flex-1">
        ...
        >
          ...
          <TouchableOpacity
            ...
            disabled={!dlNumber || !frontImage || !backImage}
            className={`mt-8 mb-6 py-4 rounded-lg ${
              dlNumber && frontImage && backImage ? 'bg-primary' : 'bg-gray-300'
            }`}
          >
...
export default UploadDrivingLicenseScreen;
